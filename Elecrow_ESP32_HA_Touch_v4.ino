...
////////////////////////////////////////////////////////////////////////////////////
String version_num = "Elecrow ESP32S3 HA v4";
#include <WiFi.h>
...
void loop() {
  ...
  if (millis() > previousMillis + loopDelay || Refresh == true) {
    ...
    lcd.drawRoundRect(0, 242, 500, 106, 10, TFT_YELLOW);
    for (int i = 3; i > 0; i--){
    ...
    //display_text(550, 250, "Pressure0=" + String(reading[0]) + "hpa", TFT_CYAN, 2);
    //display_text(550, 270, "Pressure1=" + String(reading[1]) + "hpa", TFT_CYAN, 2);
    //display_text(550, 290, "Pressure2=" + String(reading[2]) + "hpa", TFT_CYAN, 2);
    //display_text(550, 310, "Pressure3=" + String(reading[3]) + "hpa", TFT_CYAN, 2);
...
String ZCode(String msg) {
  ...
  if (msg == "A") {
    ...
    lcd.pushImage(x_pos, y_pos, icon_x_size, icon_y_size, (lgfx::rgb565_t*)sunny);
  ...
  if (msg == "C") {
    ...
    lcd.pushImage(x_pos, y_pos, icon_x_size, icon_y_size, (lgfx::rgb565_t*)sun_cloud);
  ...
  if (msg == "Y") {
    ...
    lcd.pushImage(x_pos, y_pos, icon_x_size, icon_y_size, (lgfx::rgb565_t*)stormy_rain);
